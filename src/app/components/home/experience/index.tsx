                            ...
                            {experienceData?.map((value: any, index: any) => {
                                return (
                                    <div
                                        ...
                                        <Image src={value?.icon} alt="icon" width={36} height={36} className="object-contain" />
                                        <div className="flex flex-col gap-3">
                                            <h5>{value?.role}</h5>
                                            <div className="flex items-center gap-2.5 border border-primary/10 rounded-lg py-1.5 px-3 w-fit">
